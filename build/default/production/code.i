...
void __attribute__((picinterrupt(("")))) EXT(void)
{
  if (INTF){
    RB3= 1;
    INTF = 0;
...
void alarm_set()
{
  ...
  I2C_Repeated_Start();
  I2C_Write(0xD1);
  alarm_minute = I2C_Read(1);
  alarm_hour = I2C_Read(1);
  I2C_Read(1);
  control_reg = I2C_Read(1);
  status_reg = I2C_Read(1);
  I2C_Read(1);
  I2C_Stop();
...
void main(void)
{
  ...
  while(1) {
    ...
    if(debounce())
    {
      ...
      I2C_Write(7);
      I2C_Write(0);
      I2C_Write(alarm_minute);
      I2C_Write(alarm_hour);
      I2C_Write(0x80);
      I2C_Write(4 | alarm_status);
      I2C_Write(0);
      I2C_Stop();
      _delay((unsigned long)((200)*(8000000/4000.0)));
    }
